  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
        <div className="w-10 h-10 rounded-lg bg-brand-500 mx-auto mb-4" />
        <h1 className="text-xl font-semibold mb-1">ReachInbox Scheduler</h1>
        <p className="text-slate-500 text-sm mb-6">
          Sign in to schedule and track your cold email sends.
        </p>
        <a
          href={googleLoginUrl()}
          className="flex items-center justify-center gap-2 w-full border border-slate-300 rounded-lg py-2.5 font-medium text-sm hover:bg-slate-50 transition"
        >
